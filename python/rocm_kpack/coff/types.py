...
class OptionalHeader64:
    ...
    STRUCT_FMT: ClassVar[str] = "<HBBIIIIIQIIHHHHHHI IIIHHQQQQII"
    ...
    def from_bytes(cls, data: bytes | bytearray, offset: int = 0) -> "OptionalHeader64":
        ...
        # Parse as raw bytes since struct format has spaces for readability
        fmt = "<HBBIIIIIQIIHHHHHHI" + "IIIHHQQQQII"
