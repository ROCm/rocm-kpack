...
def kpack_offload_binary(
    ...
    if fmt == "elf":
        ...
        from .elf.kpack_transform import NotFatBinaryError as ElfNotFatBinaryError
        ...
        try:
            ...
            result["format"] = "elf"
            return result
        except ElfNotFatBinaryError as e:
            raise NotFatBinaryError(str(e)) from e
    else:
        from .coff.kpack_transform import kpack_offload_binary as coff_impl
        from .coff.kpack_transform import NotFatBinaryError as CoffNotFatBinaryError
        ...
        try:
            ...
            result["format"] = "coff"
            return result
        except CoffNotFatBinaryError as e:
            raise NotFatBinaryError(str(e)) from e
